...
export const hasAccessToAnswerForm = (person: Student | Academician | InstuteMember, form: Form): boolean => {
...
export const itItTheirFormAnswer = (person: Student | Academician | InstuteMember, formAnswer: FormAnswer): boolean => {
